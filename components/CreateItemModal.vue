<template>
    <PrimeDialog
        ...
        class="item-detail-dialog-container"
    >
        <div class="item-detail-dialog-content">
            ...
            <div class="variants-section">
                ...
                >
                    ...
                    <small
                        v-if="variantErrors[index]?.name"
                        class="error-message"
                        >{{ variantErrors[index].name }}</small
                    >
                    ...
                    <small
                        v-if="variantErrors[index]?.sku"
                        class="error-message"
                        >{{ variantErrors[index].sku }}</small
                    >
                    ...
                    <div class="variant-row">
                        ...
                        <PrimeInputNumber
                            ...
                            :class="{
                                'p-invalid':
                                    variantErrors[index]?.purchasePrice,
                            }"
                        />
                    </div>
                    <small
                        v-if="variantErrors[index]?.purchasePrice"
                        class="error-message"
                    ...
                    <div class="variant-row">
                        ...
                        <PrimeInputNumber
                            ...
                            class="info-input"
                            :class="{
                                'p-invalid': variantErrors[index]?.sellingPrice,
                            }"
                        />
                    </div>
                    <small
                        v-if="variantErrors[index]?.sellingPrice"
                        class="error-message"
                        >{{ variantErrors[index].sellingPrice }}</small
                    >

                    <div
                        class="variant-row image-upload-row"
                        @click="triggerVariantFileUpload(index)"
                    >
                        <label class="info-label">Image:</label>
                        <NuxtImg
                            v-if="variant.pictureUrl"
                    ...
                    <div class="variant-row">
                        ...
                        <PrimeInputText
                            v-model="variant.note"
                            class="info-input"
                            :class="{ 'p-invalid': variantErrors[index]?.note }"
                        />
                    </div>
                    <small
                        v-if="variantErrors[index]?.note"
                        class="error-message"
                        >{{ variantErrors[index].note }}</small
                    >

                    <div class="variant-row">
                        <label class="info-label">Tags:</label>
                        <PrimeMultiSelect
                            v-model="variant.tagIds"
                            :options="tagList"
                            option-label="name"
                            option-value="id"
                            ...
                            class="info-input"
                            :class="{
                                'p-invalid': variantErrors[index]?.tagIds,
                            }"
                        />
                    </div>
                    <small
                        v-if="variantErrors[index]?.tagIds"
                        class="error-message"
                        >{{ variantErrors[index].tagIds }}</small
                    >
...
const formData = ref<Product>({
    ...
    ...(props.item || {}),
    variants:
        props.item && props.item.variants.length
            ? [...props.item.variants]
            : [{ ...defaultVariant }],
});
...
function handleVariantFileChange(event: Event) {
    ...
    if (file && currentVariantIndex.value !== null) {
        ...
        reader.onload = e => {
            formData.value.variants[currentVariantIndex.value!].pictureUrl =
...
function validateForm() {
    ...
    return (
        ...
        Object.keys(variantErrors.value).length === 0
    );
}
