<template>
    <PrimeDialog v-model:visible="visible" :modal="true" :closable="true" :dismissable-mask="true"
        header="Warehouse Creation" class="warehouse-create-dialog-container" :class="fontDMSansPrompt" >
        <div class="warehouse-create-dialog-content">
            ...
            <div class="top-section">
                ...
                <div class="info-section">
                    ...
                    <div class="info-row">
                        ...
                        <PrimeInputText v-model="editData.name" class="info-input"
                    ...
                    <div class="info-row">
                        ...
                        <PrimeInputText v-model="editData.description" class="info-input"
            ...
            <div class="footer-actions">
                <PrimeButton label="Cancel" icon="pi pi-times" class="p-button-text p-button-danger"
                    @click="onCancel" />
                <PrimeButton label="Create" icon="pi pi-check" class="p-button-success" @click="onSave" />
            </div>
        </div>
    </PrimeDialog>
</template>
...
async function onSave() {
    ...
    try {
        if (editData.value.id) {
            await $fetch(`/api/business/${currentBusinessStore.businessId}/inventory/warehouse/update`, {
                method: 'PUT',
                body: editData.value,
            })
        } else {
            await $fetch(`/api/business/${currentBusinessStore.businessId}/inventory/warehouse/create`, {
                method: 'POST',
                body: editData.value,
            })
        }
