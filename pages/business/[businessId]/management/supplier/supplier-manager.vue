    ...
    <div class="supplier-manager-page" :class="fontDMSansPrompt">
        ...
        <div class="header-actions">
            ...
            <div class="create-supplier-button-container">
                <PrimeButton label="Create Supplier" icon="pi pi-plus"
        ...
        <div class="supplier-list-section">
            <PrimeDataTable v-model:selection="selectedSupplier" :value="filteredSuppliers" selection-mode="single"
                removable-sort scrollable scroll-height="250px" responsive-layout="scroll" class="supplier-table">
                ...
                <PrimeColumn field="name" header="Supplier" sortable />
        ...
        <div class="supplier-contacts-section" v-if="selectedSupplier">
            ...
            <PrimeDataTable :value="selectedSupplierContacts" removable-sort scrollable scroll-height="250px"
                responsive-layout="scroll" class="supplier-contact-table">
                <!-- Running number column -->
                <PrimeColumn header="#">
                    <template #body="slotProps">
                        <span>{{ slotProps.index + 1 }}</span>
                ...
                <PrimeColumn field="fullName" header="Contact Person" sortable />
...
const supplierInfo = await $fetch<Supplier[]>(`/api/business/${currentBusinessStore.businessId}/supplier/list`, {
    method: 'GET',
...
const filteredSuppliers = computed(() => {
    ...
    return supplierList.value.filter((supp) =>
        supp.name.toLowerCase().includes(searchKeyword.value.toLowerCase()) ||
        (supp.description || '').toLowerCase().includes(searchKeyword.value.toLowerCase())
    )
})
